...
pub const COMPILE_TARGET_WASM32_WASI: &str = "wasm32-wasi";

pub const PROJECT_LANGUAGE_RUST: &str = "rust";
// pub const PROJECT_LANGUAGE_GO: &str = "go";
pub const PROJECT_LANGUAGE_JS: &str = "js";
